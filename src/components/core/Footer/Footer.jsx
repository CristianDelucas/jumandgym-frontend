                ...
                <Row className="row ">
                    <Col xs={12} md={4}>
                        ...
                        <ul className="list-unstyled">
                            ...
                            <li><a className="links" href="https://web.whatsapp.com/send?phone=+34654543565&text=%C2%A1Hola%20JumAndGYm!" target="_blank"><img className="img-redes" src={whatsapp} alt="whatsapp"/>
                            +34 654543565
                            </a></li>
                        </ul>
                    </Col>
